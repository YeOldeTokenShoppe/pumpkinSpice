...
/** @type {string} */
const CACHE_VERSION = '1763590613|3884809142';
/** @type {string} */
const CACHE_PREFIX = 'Starter Kit 3D P-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'November Starter Kit 3D Platformer.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["November Starter Kit 3D Platformer.html","November Starter Kit 3D Platformer.js","November Starter Kit 3D Platformer.offline.html","November Starter Kit 3D Platformer.icon.png","November Starter Kit 3D Platformer.apple-touch-icon.png","November Starter Kit 3D Platformer.audio.worklet.js","November Starter Kit 3D Platformer.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["November Starter Kit 3D Platformer.wasm","November Starter Kit 3D Platformer.pck"];
